  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      const botMessage: Message = {
        ...
        text: 'Thanks for your message! I\'m here to help you with creative tasks, brainstorming, and more.',
        sender: 'bot',
        timestamp: new Date(),
      };
          ...
          {shouldShowActionBar && (
            <div className="flex justify-center pt-8 pb-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
              <div className="flex gap-10 px-8 py-5 bg-[#faf8f3] hand-drawn-border wireframe-shadow items-center relative z-10">
                ...
                <button className="flex flex-col items-center gap-2 group transition-transform hover:-translate-y-1">
                  <div className="relative flex items-center justify-center w-12 h-12 sketch-btn">
                     <svg viewBox="0 0 100 100" className="absolute inset-0 w-full h-full text-[#1a1a1a] group-hover:text-[#4a4a4a] transition-colors" style={{ filter: 'url(#hand-drawn)' }}>
                        <path d="M 50 5 C 20 5 5 25 5 50 C 5 80 25 95 50 95 C 80 95 95 75 95 50 C 95 25 75 10 55 12" fill="none" stroke="currentColor" strokeWidth="5" strokeLinecap="round" />
                    </svg>
                ...
                <button className="flex flex-col items-center gap-2 group transition-transform hover:-translate-y-1">
                  <div className="relative flex items-center justify-center w-12 h-12 sketch-btn">
                    <svg viewBox="0 0 100 100" className="absolute inset-0 w-full h-full text-[#1a1a1a] group-hover:text-[#4a4a4a] transition-colors" style={{ filter: 'url(#hand-drawn)' }}>
                        <path d="M 45 8 C 70 5 92 25 90 50 C 88 80 65 92 40 90 C 15 88 5 65 10 40 C 15 20 30 10 48 12" fill="none" stroke="currentColor" strokeWidth="5" strokeLinecap="round" />
                    </svg>
                ...
                >
                  <button className="flex flex-col items-center gap-2 group transition-transform hover:-translate-y-1 relative z-20">
                    <div className="relative flex items-center justify-center w-12 h-12 sketch-btn">
                      <svg viewBox="0 0 100 100" className="absolute inset-0 w-full h-full text-[#1a1a1a] group-hover:text-[#4a4a4a] transition-colors" style={{ filter: 'url(#hand-drawn)' }}>
                           <path d="M 60 95 C 30 92 10 70 12 40 C 15 15 40 5 65 8 C 90 12 95 40 90 70 C 85 90 70 95 55 92" fill="none" stroke="currentColor" strokeWidth="5" strokeLinecap="round" />
                      </svg>
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className={`px-4 flex items-center justify-center border-[2.5px] border-[#1a1a1a] transition-colors sketch-btn hand-drawn-border ${
              isListening ? 'bg-[#ff6b6b] text-white animate-pulse' : 'bg-[#faf8f3] text-[#1a1a1a] hover:bg-[#e8e4d9]'
            }`}
            title="Voice Input"
          >
