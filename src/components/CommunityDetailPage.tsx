...
const mockPosts: Post[] = [
  ...
  },
  {
    ...
    likes: 34,
    comments: 2,
    timestamp: new Date('2026-01-24T18:30:00'),
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                       ...
                       <p className="mt-3 text-[#1a1a1a] font-sans text-lg leading-relaxed">
                          {post.content}
                       </p>

                       <div className="mt-4 flex flex-wrap gap-2">
                          {post.tags.map(tag => (
                             <span key={tag} className="text-xs px-2 py-1 bg-[#e8e4d9] rounded-sm handwritten border border-[#1a1a1a]/10">#{tag}</span>
                          ))}
                       </div>
                       
                       <div className="mt-4 pt-3 border-t border-[#1a1a1a]/10 flex items-center gap-6">
                          <button className="flex items-center gap-2 text-sm font-bold handwritten hover:text-red-500 transition-colors">
